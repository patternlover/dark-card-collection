      ...
      <div className="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center gap-10 lg:flex-row lg:justify-between">
          <div className="text-center lg:text-left">
            <span className="inline-flex items-center gap-2 border-2 border-[#FACC15] bg-black px-3 py-1 text-xs font-black uppercase tracking-widest text-[#FACC15]">
          ...
          <div className="flex shrink-0 flex-col items-center gap-6">
            <div className="border-2 border-black bg-[#FACC15] px-6 py-4 text-center shadow-[5px_5px_0px_0px_#fff]">
