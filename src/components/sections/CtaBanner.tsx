      ...
      <div className="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center gap-10 lg:flex-row lg:justify-between">
          <div className="text-center lg:text-left">
            <span className="inline-flex items-center gap-2 border-2 border-[var(--accent)] bg-black px-3 py-1 text-xs font-black uppercase tracking-widest text-[var(--accent)]">
            ...
            <h2 className="mt-5 text-4xl font-black uppercase leading-[0.95] tracking-tight text-white sm:text-5xl">
              La collezione
              <span className="block text-[var(--accent)]">cresce in fretta</span>
            </h2>
          ...
          <div className="flex shrink-0 flex-col items-center gap-6">
            <div className="border-2 border-black bg-[var(--accent)] px-6 py-4 text-center shadow-[5px_5px_0px_0px_#fff]">
              <p className="text-3xl font-black text-black">80 €</p>
              <p className="text-[11px] font-black uppercase tracking-widest text-black">
                e la spedizione è gratis in Italia
              </p>
            </div>

            <Link
              href="/shop"
              className="group inline-flex items-center gap-2 border-2 border-[var(--accent)] bg-[var(--accent)] px-8 py-4 text-sm font-black uppercase tracking-wide text-black shadow-[5px_5px_0px_0px_#000] transition-all hover:-translate-x-0.5 hover:-translate-y-0.5 hover:shadow-[7px_7px_0px_0px_#000] active:translate-0 active:shadow-none"
            >
              Scopri lo Shop
