...
| V1 | **Replatforming visivo storefront (taste-skill, preserve neobrutalist)**: install `redesign-existing-projects` + audit fatti; **batch P1 (F1 canvas #0a0a0a, F2 focus-visible) su `feat/visual-replatform`**. Aperte decisioni F3 (link `/shop/preorders` morto), F4 (numeri fake social proof), F5 (footer placeholder). Piano: `docs/project/sessions/2026-09-06-taste-skill-visual-replatform-plan.md` | in-progress (branch; merge dopo E2E R3) |
